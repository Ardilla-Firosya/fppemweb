    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 text-center pt-5">
          ...
          <p class="lead mb-5">You order was successfuly completed, here's your invoice.</p>
          <div class="col-md-12">
            ...
            <div class="p-3 p-lg-5 border bg-white">
              ...
              <p>
                <a href="./" class="btn btn-sm btn-outline-black">Back to homepage</a>
              </p>
            </div>
          </div>
        </div>
