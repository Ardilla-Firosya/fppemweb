      ...
      <div class="row justify-content-between">
        <div class="col-lg-5">
          <div class="intro-excerpt">
            <h1>About Us</h1>
            <p class="mb-4">
              Perkenalankan dengan tim kami dari My Room yang senantiasa menciptakan desain elegan dan indah untuk rumah
              anda.
            </p>
            <p>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
          ...
          <h3 clas>
            <a href="#"><span class="">Amalia Rodhya</span> Ulfa</a>
          </h3>
        ...
        <div class="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
          ...
          <h3 clas>
            <a href="#"><span class="">Lawaahizh Hanifah</span> P.</a>
          </h3>
          <span class="d-block position mb-4">CEO, Founder, Atty.</span>
          <p>
            Hayoloh
        ...
        <div class="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
          <img src="images/person_4.jpg" class="img-fluid mb-5" />
          <h3 clas>
            <a href="#"><span class="">Eka Fahira</span> Aprilia</a>
          </h3>
          <span class="d-block position mb-4">CEO, Founder, Atty.</span>
          <p>
            Loh gk bahaya ta?
        ...
        <div class="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
          ...
          <h3 clas>
            <a href="#"><span class="">Gilang Hayu</span> R.</a>
          </h3>
          <span class="d-block position mb-4">CEO, Founder, Atty.</span>
          <p>
            Gatau males, pengen mancing.
          </p>
          <p class="mb-0">
            <a href="#" class="more dark">Learn More <span class="icon-arrow_forward"></span></a>
          </p>
        ...
        <div class="row">
          ...
          <div class="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
            ...
            <h3 clas>
              <a href="#"><span class="">Eriansyah Alana</span> A.P.</a>
            </h3>
            <span class="d-block position mb-4">CEO, Founder, Atty.</span>
            <p>
              Bismillah, gacor.
          ...
          <div class="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
            ...
            <h3 clas>
              <a href="#"><span class="">Radithya Markarito</span> A.</a>
            </h3>
            <span class="d-block position mb-4">CEO, Founder, Atty.</span>
            <p>
              Infone maszeh.
          ...
          <div class="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
            <img src="images/person_4.jpg" class="img-fluid mb-5" />
            <h3 clas>
              <a href="#"><span class="">Ardilla</span> Firosya</a>
            </h3>
            <span class="d-block position mb-4">CEO, Founder, Atty.</span>
            <p>
              Huhu, suaraku habis.
          ...
          <div class="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
            ...
            <h3 clas>
              <a href="#"><span class="">Diajeng Putri</span> W.</a>
            </h3>
            <span class="d-block position mb-4">CEO, Founder, Atty.</span>
            <p>
              Apa lo lihat-lihat?
      ...
      <div class="container relative">
        ...
        <div class="row g-5 mb-5">
          <div class="col-lg-4">
            ...
            <p class="mb-4">
              My Room, tempat di mana impian ruang Anda menjadi nyata. Temukan
              furnitur berkualitas tinggi yang memberikan sentuhan elegan dan
              kenyamanan kepada setiap ruangan di rumah Anda.
            </p>
